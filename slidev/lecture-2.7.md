---
theme: default
title: "Lecture 2.7: The Task Tool: Spawning Subagents"
info: |
...
<div style="height: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center;">
  ...
  <div class="di-cover-subtitle">Lecture 2.7 · Domain 1 — Agentic Architecture & Orchestration (27%)</div>
</div>
...
<ul class="di-takeaway-list">
  ...
  <v-click><li>Multiple Task calls in one coordinator response = parallel subagent spawning (covered in Lecture 2.8)</li></v-click>
</ul>
