---
theme: default
title: "Lecture 7.16: Information Provenance"
info: |
...
const antiPatternBad = `Combine findings into one prose paragraph:
...
const antiPatternFix = `Each claim retains source through synthesis.
