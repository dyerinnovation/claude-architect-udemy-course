...
#   ./start-all.sh 2      → launch section 2 only (ports 3040-3053)
...
if [[ "$SECTION" == "all" || "$SECTION" == "2" ]]; then
  echo ""
  echo "Section 2: Domain 1 — Agentic Architecture & Orchestration"
  ...
  launch "lecture-2.12.md" 3051
  launch "lecture-2.13.md" 3052
  launch "lecture-2.14.md" 3053
fi
