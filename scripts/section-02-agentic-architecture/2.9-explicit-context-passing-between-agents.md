# Lecture 2.9: Explicit Context Passing Between Agents
...
Structured claim-source mappings: source URL, document name, page number, publication date. Never pass 'a summary' — preserve attribution metadata.
