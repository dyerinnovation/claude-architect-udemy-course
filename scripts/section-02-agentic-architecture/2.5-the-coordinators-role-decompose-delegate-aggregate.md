# Lecture 2.5: The Coordinator's Role: Decompose, Delegate, Aggregate
...
Task decomposition, delegation to specialized subagents, result aggregation, dynamic subagent selection. The coordinator is the brain.
