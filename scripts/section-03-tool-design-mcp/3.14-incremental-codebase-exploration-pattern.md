# Lecture 3.14: Incremental Codebase Exploration Pattern
...
Start with Grep to find entry points → Read to follow imports and trace flows. Don't read all files upfront.
