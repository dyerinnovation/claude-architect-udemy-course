# Lecture 6.10: Coverage Annotations in Synthesis Output
...
Indicate which findings are well-supported vs which areas have gaps due to unavailable sources. Honest caveats > hiding incompleteness.
