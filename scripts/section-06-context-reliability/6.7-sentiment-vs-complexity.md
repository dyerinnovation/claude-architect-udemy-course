# Lecture 6.7: Sentiment vs Complexity
...
Sentiment is NOT a reliable escalation trigger. Frustrated customer → acknowledge + offer to resolve. Only escalate if customer reiterates preference for human.
