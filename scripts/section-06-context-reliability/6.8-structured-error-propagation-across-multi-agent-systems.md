# Lecture 6.8: Structured Error Propagation Across Multi-Agent Systems
...
Include: failure type, what was attempted, partial results, alternative approaches. Anti-patterns: silent suppression, terminate on single failure, generic status.
