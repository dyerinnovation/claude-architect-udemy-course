# Lecture 4.2: What Gets Shared via Version Control and What Doesn't
...
Project-level (.claude/) = shared. User-level (~/.claude/) = personal only. Critical distinction the exam tests.
