# Lecture 4.7: Skills in .claude/skills/: SKILL.md Frontmatter Deep Dive
...
Skills = on-demand workflows. SKILL.md with frontmatter. Triggered via slash command or automatically when relevant.
