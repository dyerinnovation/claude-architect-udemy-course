...
<!-- SLIDE: 6 — Project-scoped example -->
...
<!-- SLIDE: 8 — Symptoms of wrong scope -->
...
<!-- SLIDE: 10 — Continuity: where Domain 2 and Domain 3 shake hands -->
