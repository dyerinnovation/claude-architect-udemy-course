...
<!-- SLIDE: 4 — Opening: the context wall -->
...
<!-- SLIDE: 7 — Walkthrough: trace process_refund -->
...
<!-- SLIDE: 8 — When to spawn an Explore subagent -->
...
<!-- SLIDE: 9 — Anti-pattern: two exploration traps -->
...
<!-- SLIDE: 11 — Section recap: Domain 2 in one sentence -->
