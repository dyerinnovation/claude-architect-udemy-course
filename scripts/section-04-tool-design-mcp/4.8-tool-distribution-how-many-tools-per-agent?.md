...
<!-- SLIDE: 5 — Why: tool selection is a decision -->
...
<!-- SLIDE: 6 — Anti-pattern: dump all tools on one agent -->
...
<!-- SLIDE: 7 — Scoped tool access: the right distribution -->
...
<!-- SLIDE: 8 — When to break the rule: scoped cross-role -->
...
<!-- SLIDE: 9 — Exam framing: the "more tools" distractor -->
...
<!-- SLIDE: 10 — Continuity: six-pick-four reminder -->
