# Lecture 5.3: The @import Syntax for Modular CLAUDE.md
...
Reference external files from CLAUDE.md. Keeps configs modular. Approval dialog on first encounter. Example: importing per-package standards.
